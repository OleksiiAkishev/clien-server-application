...
namespace UniversityMgmtSystemServerApi.Migrations
{
    ...
    [Migration("20230503123642_EnrollmentEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityMgmtSystemServerApi.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStudent", b =>
                {
                    b.HasOne("UniversityMgmtSystemServerApi.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UniversityMgmtSystemServerApi.Models.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniversityMgmtSystemServerApi.Models.Course", b =>
                {
                    b.HasOne("UniversityMgmtSystemServerApi.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("UniversityMgmtSystemServerApi.Models.Teacher", b =>
                {
                    b.HasOne("UniversityMgmtSystemServerApi.Models.Department", null)
                        .WithMany("Teachers")
                        .HasForeignKey("DepartmentId");
                });
